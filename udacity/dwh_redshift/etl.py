...
def load_staging_tables(cur, conn):
    """
    Copies log_data and song_data from udacity s3 bucket into staging tables on redshift
...
def insert_tables(cur, conn):
    """
    Queries data from staging tables and inserts into Sparkify fact and dimension tables
